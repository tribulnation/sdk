...
1. Status: accepted; amended by [ADR 0004](0004-empty-book-consistency-coverage.md), [ADR 0006](0006-release-evidence-scope.md), [ADR 0009](0009-catalogue-owned-asset-identity.md) and [ADR 0013](0013-all-read-suites-release-gate.md)
2. Date: 2026-09-10
