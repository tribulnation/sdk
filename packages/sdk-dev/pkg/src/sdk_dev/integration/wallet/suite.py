...
def test_deposit_methods_can_be_fetched(wallet_result: WalletResult):
  ...
  if wallet_result.deposit_unsupported is not None:
    pytest.skip(wallet_result.deposit_unsupported)
...
def test_withdrawal_methods_can_be_fetched(wallet_result: WalletResult):
  ...
  if wallet_result.withdrawal_unsupported is not None:
    pytest.skip(wallet_result.withdrawal_unsupported)
