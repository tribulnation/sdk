# tribulnation-binance 0.3.0

## SDK 2 compatibility

1. Requires tribulnation-sdk >=2.0.0 and the Typed dependency floors declared in this package.
2. Private reporting and snapshots cover spot-side accounts only. Public USD-M candles, tickers, funding and statistics remain available independently of private futures eligibility.
