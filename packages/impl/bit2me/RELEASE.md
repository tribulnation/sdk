...
2. Sanitized local results, content fingerprints and published dependency pins are committed under [release-evidence/bit2me](https://github.com/tribulnation/sdk/tree/release/sdk/release-evidence/bit2me). All 12 reports independently verify in a second clean environment.
