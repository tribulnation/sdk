# tribulnation-kraken 0.2.0

## SDK 2 compatibility

1. Requires tribulnation-sdk >=2.0.0 and the Typed dependency floors declared in this package.
2. Packages the prepared market, earn, wallet and report surfaces with SDK 2 routing and exchange metadata. Further public-market expansion remains deferred.
...
3. Merging release/kraken into main triggers publication of tribulnation-kraken 0.2.0. No merge or publication has occurred during PR preparation.
...
2. Sanitized local results, content fingerprints and published dependency pins are committed under [release-evidence/kraken](https://github.com/tribulnation/sdk/tree/release/sdk/release-evidence/kraken). All 12 reports independently verify in a second clean environment.
