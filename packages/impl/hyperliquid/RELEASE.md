# tribulnation-hyperliquid 0.7.0

## SDK 2 compatibility

1. Requires tribulnation-sdk >=2.0.0 and the Typed dependency floors declared in this package.
2. Retains native exchange/market IDs, including the empty default ID and HIP-3 prefixes; adds exchange names and bounded candles. Midpoint and oracle values are not relabelled as last trades. Funding collection remains subject to native rate limits and retention.
...
3. Merging release/hyperliquid into main triggers publication of tribulnation-hyperliquid 0.7.0. No merge or publication has occurred during PR preparation.
...
2. Sanitized local results, content fingerprints and published dependency pins are committed under [release-evidence/hyperliquid](https://github.com/tribulnation/sdk/tree/release/sdk/release-evidence/hyperliquid). All 12 reports independently verify in a second clean environment.
