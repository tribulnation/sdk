...
2. Distinguishes Advanced Trade spot and International Exchange products, adds bid/ask enrichment, and uses public INTX funding history. SDK product discovery still requires Coinbase credentials; public INTX history does not grant private access.
