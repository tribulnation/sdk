# tribulnation-bybit 0.2.0

## SDK 2 compatibility

1. Requires tribulnation-sdk >=2.0.0 and the Typed dependency floors declared in this package.
2. Adopts bounded candles, typed market values, exchange metadata and SDK 2 dependency floors.
...
3. Merging release/bybit into main triggers publication of tribulnation-bybit 0.2.0. No merge or publication has occurred during PR preparation.
...
2. Sanitized local results, content fingerprints and published dependency pins are committed under [release-evidence/bybit](https://github.com/tribulnation/sdk/tree/release/sdk/release-evidence/bybit). All 12 reports independently verify in a second clean environment.
